...
```{r}
ggplot(df, aes(x = age)) +   geom_histogram(binwidth = 5, fill = "purple", alpha = 0.7) +   labs(title = "Distribution of Age", x = "Age (years)", y = "Frequency") +   theme_minimal()
```
...
Regression Model (Train & Test Split)
